...
def test_filename_not_string():
    ...
    with pytest.raises(TypeError):
        filename = 6
        cad2vox.voxelise(filename,"AMAZE_Sample",gridsize = 100)
    assert TypeError
...
def test_no_Tertahedrons(cleanup):
    ...
    cad2vox.voxelise("inputs/Sphere.stl","outputs/Sphere",gridsize = 100)
...
def test_no_Tertahedrons_use_tetra(cleanup):
    ...
    with pytest.raises(ValueError):
        cad2vox.voxelise("inputs/Sphere.stl","outputs/Sphere",gridsize = 100,use_tetra=True)
...
def test_no_mat_data(cleanup):
    ...
    cad2vox.voxelise("inputs/Sphere.med","outputs/Sphere_nomats",gridsize = 100)
...
# test if greyscale.csv file is auto-generated if None given
    ...
    cad2vox.voxelise("inputs/AMAZE_Sample.med","outputs/AMAZE_Sample",gridsize = 100)
